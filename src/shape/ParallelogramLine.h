...
private:
  vec2 originalStart; // Backup posisi asli untuk mencegah floating-point drift
  vec2 originalEnd;   // Backup posisi asli
  vec2 originalIntersecCrossLine;
