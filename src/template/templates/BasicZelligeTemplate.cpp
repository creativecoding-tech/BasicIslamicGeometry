...
void BasicZelligeTemplate::setupOctagramLines(std::vector<std::unique_ptr<AbstractShape>>& shapes) {
	...
	shapes.push_back(std::make_unique<OctagramLine>(posE, posEnd, posG, "0"));
	...
	shapes.push_back(std::make_unique<OctagramLine>(posG, posEnd1, posB, "1"));
	...
	shapes.push_back(std::make_unique<OctagramLine>(posB, posEnd2, posI, "2"));
	...
	shapes.push_back(std::make_unique<OctagramLine>(posI, posEnd3, posD, "3"));
	...
	shapes.push_back(std::make_unique<OctagramLine>(posD, posEnd4, posH, "4"));
	...
	shapes.push_back(std::make_unique<OctagramLine>(posH, posEnd5, posC, "5"));
	...
	shapes.push_back(std::make_unique<OctagramLine>(posC, posEnd6, posF, "6"));
	...
	shapes.push_back(std::make_unique<OctagramLine>(posF, posEnd7, posE, "7"));
}
